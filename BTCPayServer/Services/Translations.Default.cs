...
"""
{
  ...
  "Connect xBilling to your Shopify checkout experience to accept Bitcoin.": "",
  ...
  "Easily log into xBilling on another device using a simple login code from an already authenticated device.": "",
  "Edit": "",
  "Edit Field": "",
  "Edit Form": "",
  "Edit Item": "",
  ...
  "email rules": "",
  "Email Rules": "",
  "Email rules allow xBilling to send customized emails from your store based on events.": "",
  ...
  "Extended public key": "",
  "Extends the xBilling Dark theme": "",
  "Extends the xBilling Light theme": "",
  ...
  "Generate a new api key to use xBilling through its API.": "",
  ...
  "Generated Code": "",
  "Get Link": "",
  "Give other registered xBilling users access to your store. See the {0} for granted permissions.": "",
  ...
  "If xBilling shows you an invalid balance, {0}.<br />If some transactions appear in xBilling, but are missing in another wallet, {1}.": "",
  ...
  "Import keys to RPC": "",
  "Import wallet file": "",
  "Import public keys using the open-source BTCPay Vault application": "",
  ...
  "Payout Processors": "",
  "Payout Processors allow xBilling to handle payouts in an automated way.": "",
  ...
  "Webhooks": "",
  "Webhooks allow xBilling to send HTTP events related to your store to another server.": "",
  "Welcome to {0}": "",
